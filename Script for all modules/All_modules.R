...
# Load packages  -----------------------------------------------------
HCBioSIM_SOIL<-c("rpart", "rpart.plot", "Cubist", "caret", "stringi", "stringr", "scales", "RColorBrewer",
                 "dplyr", "ggplot2", "tidyverse", "plyr", "RCurl")
...
# Sediment module -----------------------------------------------------
sedimentD<-read.csv("https://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@raw.githubusercontent.com/GusGroLimon/HCBioSIM-app/main/TrainingSetSediment.csv")
...
# Soil module -------------------------------------------------------------
soilD = read.csv("https://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@raw.githubusercontent.com/GusGroLimon/HCBioSIM-app/main/TrainingSetSoil.csv") #load trainset 
...
Waterdc = read.csv("https://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@raw.githubusercontent.com/GusGroLimon/HCBioSIM-app/main/TrainingSetWater_Seawater.csv")
